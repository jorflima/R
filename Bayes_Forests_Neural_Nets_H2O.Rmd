...
On the previous exercise I used a 20% sample of my data because of memory allocation problems. In this final project I will try to use the full dataset named "NIS_imputed" to fit three models: Naive Bayes, Random Forest and Deep Learning. I will use the H2o library / workframe.
