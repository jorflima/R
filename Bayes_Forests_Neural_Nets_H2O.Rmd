...
On the previous exercise I used a 20% sample of my data because of memory allocation problems. In this final project I will try
...
than the previous exercise using the e1071 package.
...
comparable to the models in the previous exercise:
...
was consistent with the previous exercise. The news here is that wscore_ahrq was placed second and was 
...
As seen before in the past exercise only Stage 3 was reliably categorized by the algorithms.
